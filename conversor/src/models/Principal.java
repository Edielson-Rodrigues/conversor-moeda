...
public class Principal {
    ...
    public static void main(String[] args){
        ...
        while(true){
            ...
            if(respostaPrimeiroMenu[0].equals(conversores[0]) && respostaPrimeiroMenu[2].hashCode() != -1){
                ...
                if(escolhaMoedas[2].hashCode() != -1){
                    ...
                    if(isNumeric(valor)){
                        ...
                        String resultado = opcoesConversoesMoeda.get(escolhaMoedas[1].hashCode())[0] +": "+ valorNumerico +"\n"+ opcoesConversoesMoeda.get(escolhaMoedas[1].hashCode())[1] +": "+resultadoConversao;
                        
                        // Chamando função para exibir resultado
                        mensagemDialogo(resultado, "Resultado da conversão", JOptionPane.INFORMATION_MESSAGE);
                        
                    }else{
                        mensagemDialogo("O valor deve conter apenas números", "Error",  JOptionPane.ERROR_MESSAGE);
                    }
                ...
                */
                ...
                if(escolhaTemperaturas[2].hashCode() != -1){
                    ...
                    if(isNumeric(valor)){
                        ...
                        String resultado = opcoesConversoesTemperatura.get(escolhaTemperaturas[1].hashCode())[0] +": "+ valorNumerico +"\n"+ opcoesConversoesTemperatura.get(escolhaTemperaturas[1].hashCode())[1] +": "+resultadoConversao;
                        
                        mensagemDialogo(resultado, "Resultado conversão", JOptionPane.INFORMATION_MESSAGE);
            ...
            // Escolha (fechar ou continuar)
            int escolhaContinuar = JOptionPane.showConfirmDialog(null, "Deseja continuar?", "Continur ou sair", JOptionPane.YES_NO_CANCEL_OPTION);

            if(escolhaContinuar == 2){
                mensagemDialogo("Programa concluído", "Tchauu", JOptionPane.INFORMATION_MESSAGE);
                break;
            }else if(escolhaContinuar == 1 || escolhaContinuar == -1){
                mensagemDialogo("Programa finalizado", "Tchauu", JOptionPane.INFORMATION_MESSAGE);
                break;
            }         
    ...
    public static void mensagemDialogo(String mensagem, String titulo, int tipo){
